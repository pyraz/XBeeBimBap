...
public class InvalidPacketError extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("InvalidPacketError");
        metaclass.setRubyStaticAllocator(InvalidPacketError.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: InvalidPacketError");
     ...
     */
    private InvalidPacketError(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new InvalidPacketError(ruby, metaClass);
    }
