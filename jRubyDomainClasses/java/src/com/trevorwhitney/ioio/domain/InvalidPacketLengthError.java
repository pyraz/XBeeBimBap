...
public class InvalidPacketLengthError extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("InvalidPacketLengthError");
        metaclass.setRubyStaticAllocator(InvalidPacketLengthError.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: InvalidPacketLengthError");
     ...
     */
    private InvalidPacketLengthError(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new InvalidPacketLengthError(ruby, metaClass);
    }
     ...
     * @param metaclass The RubyClass representing the Ruby class of this object
     */
    public InvalidPacketLengthError() {
