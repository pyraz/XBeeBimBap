...
public class XBeeResponseFactory extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("XBeeResponseFactory");
        metaclass.setRubyStaticAllocator(XBeeResponseFactory.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: XBeeResponseFactory");
     ...
     */
    private XBeeResponseFactory(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new XBeeResponseFactory(ruby, metaClass);
    }
     ...
     * @param metaclass The RubyClass representing the Ruby class of this object
     */
    public XBeeResponseFactory() {
        this(__ruby__, __metaclass__);
        RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "initialize");
    }

    
    public static Object generate(Object packet) {
        IRubyObject ruby_packet = JavaUtil.convertJavaToRuby(__ruby__, packet);
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), __metaclass__, "generate", ruby_packet);
        return (Object)ruby_result.toJava(Object.class);

    }

    
    public static Object parse_packet() {

        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), __metaclass__, "parse_packet");
        return (Object)ruby_result.toJava(Object.class);
